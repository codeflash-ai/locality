...
forwarded_env=(
  ...
  LOCALITY_GMAIL_LIVE_CONNECTION_ID
  LOCALITY_GMAIL_LIVE_CREDENTIAL_JSON
  LOCALITY_GMAIL_LIVE_KEEP_TMP
  LOCALITY_GMAIL_LIVE_MOUNT_ID
  LOCALITY_GMAIL_LIVE_TO_EMAIL
  LOCALITY_GMAIL_LIVE_FILE_READ_TIMEOUT
  LOCALITY_GMAIL_LIVE_SENT_MARKER_WAIT_ATTEMPTS
