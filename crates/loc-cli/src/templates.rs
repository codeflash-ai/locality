...
const MANIFEST_FILE: &str = ".locality-pack.yaml";
const LEGACY_MANIFEST_FILE: &str = "loc-pack.yaml";

const FOUNDER_PROOF_OF_WORK_MANIFEST: &str =
    include_str!("../../../templates/packs/founder-proof-of-work/.locality-pack.yaml");
const FOUNDER_PROOF_OF_WORK_FILES: &[EmbeddedTemplateFile] = &[
    EmbeddedTemplateFile {
        path: ".locality-pack.yaml",
        body: include_str!("../../../templates/packs/founder-proof-of-work/.locality-pack.yaml"),
    },
    EmbeddedTemplateFile {
        path: "README.md",
...
const FOCUSED_INBOX_MANIFEST: &str =
    include_str!("../../../templates/packs/focused-inbox/.locality-pack.yaml");
const FOCUSED_INBOX_FILES: &[EmbeddedTemplateFile] = &[
    EmbeddedTemplateFile {
        path: ".locality-pack.yaml",
        body: include_str!("../../../templates/packs/focused-inbox/.locality-pack.yaml"),
    },
    EmbeddedTemplateFile {
        path: "README.md",
...
pub fn run_template_apply(
    ...
    Ok(TemplateApplyReport {
        ...
        path: path.clone(),
        suggested_next: vec![
            format!("loc diff {}", shell_quote(&path)),
            format!("loc push {} -y", shell_quote(&path)),
        ],
    })
}
