...
use afs_core::push::{PushPipelineAction, PushPipelineResult};
...
pub fn auto_save_enabled_for_path<S>(
    ...
    mount_id: &MountId,
    relative_path: &Path,
) -> AfsResult<Option<AutoSaveEnrollmentRecord>>
where
...
mod tests {
    ...
    use afs_core::planner::{PlanDegradation, PlanDegradationKind, PushOperation, PushPlan};
