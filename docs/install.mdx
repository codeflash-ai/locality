...
| --- | --- | --- |
| macOS | Homebrew cask | `*-notarized-aarch64.dmg` |
...
| Windows | GitHub installer | `Locality-release-windows-x86_64-setup.exe` |
...
2. Download the latest notarized Apple Silicon DMG: `*-notarized-aarch64.dmg`.
