...
Check navigation paths directly when editing `docs.json`:
...
The isolated docs workspace avoids Mintlify scanning internal repository files that are not part of the published site.
