...
These workflows fit Locality's current file-based model.
...
```bash
loc create page --title "Launch FAQ" --parent "$HOME/Library/CloudStorage/Locality/notion-main/Content Calendar"
```

Then review and push:

```bash
loc diff "$HOME/Library/CloudStorage/Locality/notion-main/Content Calendar/Launch FAQ/page.md"
loc push "$HOME/Library/CloudStorage/Locality/notion-main/Content Calendar/Launch FAQ/page.md" -y
```
...
```bash
loc okf export "$HOME/Library/CloudStorage/Locality/notion-main/Engineering Wiki" --out "$HOME/Desktop/engineering-wiki-okf"
```
