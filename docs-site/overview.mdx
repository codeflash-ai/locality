...
<Columns cols={2}>
  <Card title="Locality Cloud" icon="shield-check" href="/locality-cloud">
    Set up an organization, connect hosted sources, grant folder access, create Workspace Profiles, and issue sandbox keys.
  </Card>
