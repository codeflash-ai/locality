...
export type SourceConnectorId = "notion" | "google-docs" | "google-calendar" | "gmail" | "granola";
...
const SOURCE_CONNECTORS: SourceConnectorId[] = ["notion", "google-docs", "google-calendar", "gmail", "granola"];
