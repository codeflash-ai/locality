...
function Onboarding({
  ...
  async function connectGoogleOnboarding(connector: "google-docs" | "google-calendar" | "gmail") {
...
function googleOAuthConnectCommand(connector: "google-docs" | "google-calendar" | "gmail") {
  switch (connector) {
    case "google-docs":
