...
codebase at `{{SANDBOX_HOME}}/workspace/locality` only when code evidence is needed.
...
The brief should be concise, specific, and grounded in source paths, MCP results,
