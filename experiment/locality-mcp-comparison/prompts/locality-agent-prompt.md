...
Required work:
1. Inspect relevant commits with `git show`, `git diff --stat`, and file reads as needed.
2. Read the hydrated Notion context inventory and search hits.
3. Open the most relevant mounted `page.md` files to connect git work to launch context.
4. Read the benchmark case section in the Locality Launch Amika Environment page.
5. Write the final Markdown report to `OUT_DIR/report-body.md`.
